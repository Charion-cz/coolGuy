...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>/css/pages-JD-index.css" />
</head>
...
<body>
			...
			<div class="yui3-g NavList">
				...
				<div class="yui3-u Center navArea">
					<ul class="nav">
						...
						<li class="f-item">
							<a href="seckill-index.html">秒杀</a>
						</li>
					</ul>
				</div>
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				<li class="yui3-u-1-6  clock">
					<div class="time">
						<img src="<%=basePath%>/img/clock.png" />
						<h3>今日推荐</h3>
					</div>
				</li>
				<li class="yui3-u-5-24">
					<a href="list.html">
						<img src="<%=basePath%>/img/today01.png" />
					</a>
				</li>
				<li class="yui3-u-5-24">
					<img src="<%=basePath%>/img/today02.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="<%=basePath%>/img/today03.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="<%=basePath%>/img/today04.png" />
				</li>
			</ul>
		</div>
	</div>
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="" class="pic">
									<img src="<%=basePath%>/img/like_02.png" alt="" />
								</a>
								<div class="like-text">
							...
							<dd>
								<a href="" class="pic">
									<img src="<%=basePath%>/img/like_01.png" alt="" />
								</a>
								<div class="like-text">
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="" class="pic">
									<img src="<%=basePath%>/img/like_03.png" alt="" />
								</a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							...
							<dd>
								<a href="" class="pic">
									<img nsrc="<%=basePath%>./../assets/img/like_02.png" alt="" />
								</a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
		...
		<div class="py-container">
			...
			<div class="clearfix yui3-g Interest">
				...
				<div class="yui3-u row-405 Interest-conver">
					<img src="<%=basePath%>/img/interest01.png" />
				</div>
				<div class="yui3-u row-225 Interest-conver-split">
					<h5>好东西</h5>
					<img src="<%=basePath%>/img/interest02.png" />
					<img src="<%=basePath%>/img/interest03.png" />
				</div>
				<div class="yui3-u row-405 Interest-conver-split blockgary">
					<h5>品牌街</h5>
					<div class="split-bt">
						<img src="<%=basePath%>/img/interest04.png" />
					</div>
					<div class="x-img fl">
						<img src="<%=basePath%>/img/interest05.png" />
					</div>
					<div class="x-img fr">
						<img src="<%=basePath%>/img/interest06.png" />
					</div>
				</div>
				<div class="yui3-u row-165 brandArea">
					...
					<ul class="yui3-g brand-list">
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand01.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand02.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand03.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand04.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand05.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand06.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand07.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand08.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand09.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand10.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand11.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand12.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand13.png" />
						</li>
						<li class="yui3-u-1-2 brand-pit">
							<img src="<%=basePath%>/img/brand03.png" />
						</li>
				...
				<div id="tab1" class="tab-pane active">
					<div class="yui3-g Floor-1">
						<div class="yui3-u Left blockgary">
							...
							<img src="<%=basePath%>/img/floor-1-1.png" />
						</div>
						<div class="yui3-u row-330 floorBanner">
							<div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
								...
								<div class="carousel-inner">
									<div class="active item">
										<img src="<%=basePath%>/img/floor-1-b01.png">
									</div>
									<div class="item">
										<img src="<%=basePath%>/img/floor-1-b02.png">
									</div>
									<div class="item">
										<img src="<%=basePath%>/img/floor-1-b03.png">
									</div>
								</div>
						...
						<div class="yui3-u row-220 split">
							...
							<div class="floor-conver-pit">
								<img src="<%=basePath%>/img/floor-1-2.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="<%=basePath%>/img/floor-1-3.png" />
							</div>
						</div>
						<div class="yui3-u row-218 split">
							<img src="<%=basePath%>/img/floor-1-4.png" />
						</div>
						<div class="yui3-u row-220 split">
							<span class="floor-x-line"></span>
							<div class="floor-conver-pit">
								<img src="<%=basePath%>/img/floor-1-5.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="<%=basePath%>/img/floor-1-6.png" />
							</div>
						</div>
					</div>
				</div>
	...
	<div class="brand">
		<div class="py-container">
			<ul class="Brand-list blockgary">
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_21.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_03.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_05.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_07.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_09.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_11.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_13.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_15.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_17.png" />
				</li>
				<li class="Brand-item">
					<img src="<%=basePath%>/img/brand_19.png" />
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="py-container">
			<div class="footlink">
				...
				<div class="Mod-copyright">
					...
					<p>地址： 邮编： 电话： 传真：</p>
					<p>京ICP备080056565号京公网安备11010856565</p>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="<%=basePath%>/js/pages/index.js"></script>
</body>
